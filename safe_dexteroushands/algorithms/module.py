...
class Actor(nn.Module):
    ...
    def act(self, observations, states):
        ...
        return actions.detach(), actions_log_prob.detach(), actions_mean.detach(), action_std.detach()
...
class Critic(nn.Module):
    ...
    def __init__(self, obs_shape, states_shape, model_cfg, asymmetric=False):
